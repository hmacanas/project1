...
if strcmp(cost,'Low')
    R = 10.^((10*log10(P*eAmp) + loss + gainFixed + FSPL + gainGnd - 10*log10(kb) - 10*log10(Ts) - EbNo - margin)/10);
elseif strcmp(cost,'High');
    R = 10.^((10*log10(P*eAmp) + loss + gainDepl + FSPL + gainGnd - 10*log10(kb) - 10*log10(Ts) - EbNo - margin)/10);
else
